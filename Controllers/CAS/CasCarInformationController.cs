...
namespace RentCar.Controllers.CAS
{
    public class CasCarInformationController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //var cR_Cas_Sup_Car_Information = db.CR_Cas_Sup_Car_Information.Where(x => x.CR_Cas_Sup_Car_Lessor_Code == LessorCode)

            ////var cR_Cas_Sup_Car_Information = db.CR_Cas_Sup_Car_Information.Where(x => x.CR_Cas_Sup_Car_Lessor_Code == LessorCode && x.CR_Cas_Sup_Car_Status != "D" &&
            ////x.CR_Cas_Sup_Car_Status != "S")
