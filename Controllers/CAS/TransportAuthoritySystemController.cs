...
{
    public class TransportAuthoritySystemController : Controller
    {
        private RentCarDBEntities db = new RentCarDBEntities();

        // GET: TransportAuthoritySystem
        public ActionResult Index()
        {
            var cR_Cas_Company_Contract = db.CR_Cas_Company_Contract.Include(c => c.CR_Mas_Sup_Procedures).Include(c => c.CR_Mas_Sup_Sector).Include(c => c.CR_Mas_Com_Lessor);
            return View(cR_Cas_Company_Contract.ToList());
        }

        // GET: TransportAuthoritySystem/Details/5
        ...
        // GET: TransportAuthoritySystem/Create
        ...
        // POST: TransportAuthoritySystem/Create
        ...
        public ActionResult Create([Bind(Include = "CR_Cas_Company_Contract_No,CR_Cas_Company_Contract_Year," +
            ...
            , DateTime CR_Cas_Company_Contract_Date,
        ...
        // GET: TransportAuthoritySystem/Edit/5
        ...
        // POST: TransportAuthoritySystem/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: TransportAuthoritySystem/Delete/5
        ...
        // POST: TransportAuthoritySystem/Delete/5
