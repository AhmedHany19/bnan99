...
{
    public class TransferFromRenterController : Controller
    {
        private RentCarDBEntities db = new RentCarDBEntities();

        // GET: TransferFromRenter
        ...
        public ActionResult Create(string id1, string id2)
        {
            ...
            var autoInc = GetLastRecord(LessorCode, "64");
            var renter = db.CR_Cas_Renter_Lessor.FirstOrDefault(r => r.CR_Cas_Renter_Lessor_Id == id1 && r.CR_Cas_Renter_Lessor_Code == id2);
            if (renter != null)
            {
                ViewBag.Administrative_Procedures_No = y + "-" + sector + "-" + "64" + "-" + LessorCode + "-" + autoInc.CR_Cas_Administrative_Procedures_No;
                ...
                ViewBag.CR_Cas_Sup_Bank_Code = new SelectList(db.CR_Cas_Sup_Bank.Where(b => b.CR_Cas_Sup_Bank_Com_Code == LessorCode && b.CR_Cas_Sup_Bank_Mas_Code != "00" && b.CR_Cas_Sup_Bank_Status=="A")
                    , "CR_Cas_Sup_Bank_Code", "CR_Cas_Sup_Bank_Ar_Name");
            }
            return View(renter);
        }

        // POST: TransferFromRenter/Create
        ...
        public ActionResult Create([Bind(Include = "CR_Cas_Renter_Lessor_Id,CR_Cas_Renter_Lessor_Code," +
            ...
            "CR_Cas_Renter_Lessor_KM,CR_Cas_Renter_Lessor_Balance,CR_Cas_Renter_Rating,CR_Cas_Renter_Membership_Code,CR_Cas_Renter_Admin_Membership_Code," +
            "CR_Cas_Renter_Lessor_Status,CR_Cas_Renter_Lessor_Reasons")] CR_Cas_Renter_Lessor cR_Cas_Renter_Lessor, string TransferedVal, string Reasons
            , string Iban, string CR_Cas_Sup_Bank_Code,string CR_Mas_Sup_Bank)
        {
            var LessorCode = Session["LessorCode"].ToString();
            ...
            if (ModelState.IsValid)
            {
                ...
                Ad.CR_Cas_Administrative_Procedures_No = y + "-" + sector + "-" + "64" + "-" + LessorCode + "-" + autoInc.CR_Cas_Administrative_Procedures_No;
                ...
                Ad.CR_Cas_Administrative_Procedures_Code = "64";
                Ad.CR_Cas_Administrative_Int_Procedures_Code = 64;
                ...
                if (renter != null)
                {
                    ...
                    renter.CR_Cas_Renter_Lessor_Balance += (val * -1);
                ...
                Receipt.CR_Cas_Account_Receipt_Payment = val;
